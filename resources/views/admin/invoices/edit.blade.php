		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-body">
					...
					<form method="post" action="{{ url('admin/invoices/edit/'.$oldRecord->id) }}" enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="row mb-3">
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input type="number" name="net_total" value="{{ $oldRecord->net_total }}" class="form-control" required>
							</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input type="date" name="invoices_date" value="{{ $oldRecord->invoices_date }}" class="form-control" required>
							</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input type="text" name="total_amount" value="{{ $oldRecord->total_amount }}" class="form-control" required>
							</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input type="text" name="total_discount" value="{{ $oldRecord->total_discount }}" class="form-control" required>
							</div>
						</div>
