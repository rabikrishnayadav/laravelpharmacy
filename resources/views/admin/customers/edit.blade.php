				...
				<div class="card-body">
					...
					<form method="post" action="{{ url('admin/customers/edit/'.$getRecord->id) }}" enctype="multipart/form-data">
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input type="number" name="contact_number" class="form-control" value="{{ $getRecord->contact_number }}" required>
							</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input type="text" name="doctor_name" class="form-control" value="{{ $getRecord->doctor_name }}" required>
							</div>
						</div>
